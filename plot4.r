...
par(mfrow=c(2,2))
par(oma=c(1,2,0,0),mar=c(4,4,4,2),mfrow=c(2,2))
#PP1
with(pwrconspsdate, plot(Date_Time,Global_active_power,col = 'black', type="l", xlab = "",ylab = "Energy sub metering"))
#PP2
with(pwrconspsdate, plot(Date_Time,Voltage,col = 'black', type="l",xlab = "datetime"))
# PP3
...
# PP4
with(pwrconspsdate, plot(Date_Time, Global_reactive_power,col = 'black', type="l",xlab = "datetime"))
dev.off()
